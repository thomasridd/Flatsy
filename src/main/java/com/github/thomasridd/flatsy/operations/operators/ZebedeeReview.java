 ...
 *
 */
public class ZebedeeReview implements FlatsyOperator {
    CollectionDescription collectionDescription;

    public ZebedeeReview(CollectionDescription collectionDescription) {
    ...
    public void apply(FlatsyObject object) {
        try {
            ...
            review(collectionDescription.id, object.uri, ZebedeeHost.httpSecondSetOfEyes);
        } catch (IOException e) {
